		...
		<div class="container">
			...
			<div class="box">
				<form method="POST" action="" enctype="multipart/form-data">
					<input type="text" name="nama" placeholder="Masukkan Nama Paket" class="input-control" required>
					<input type="text" name="harga" placeholder="Harga Paket" class="input-control" required>
					...
					<input type="submit" name="submit" value="Tambah" class="btn1">
					<a href="data_paket.php" class="btn2">Batal</a>
				</form>
				<?php 
				...
				if (isset($_POST['submit'])) {
					...
					if (!in_array($type2, $type_diizinkan)) {
						...
						$insert = mysqli_query($con, "INSERT INTO tb_paket VALUES (
									null,
									'".$nama."',
									'".$deskripsi."',
									'".$harga."',
									...
									'".$status."')");
						if ($insert) {
							echo "<script>window.location='data_paket.php'</script>";
						}else {
