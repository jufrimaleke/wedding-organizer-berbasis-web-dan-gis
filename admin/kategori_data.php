...
<body>
	...
	<div class="section">
		<div class="container">
			<h3>Data Kategori</h3>
			<div class="box">
				<p><button class="btn4"><a href="tambah_k" class="btn4">Tambah Data</a></button></p><br>
				<table border="1" cellpadding="0" class="tabel">
					...
					<tbody>
						<?php
						$no = 1;
						$query = mysqli_query($con, "SELECT * FROM tb_category ORDER BY category_id DESC");
						...
						<tr>
							...
							<td>
								<a href="edit_k?idk=<?php echo $row['category_id'] ?>">Edit</a> || <a href="hapus_kategori.php?idk=<?php echo $row['category_id'] ?>" onclick="return confirm('Data akan dihapus?')">Hapus</a>
							</td>
						</tr>
					<?php }}else{?>
						<tr>
